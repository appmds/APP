...
public class BuscaControllerTest extends AndroidTestCase {
	...
	public void testTransformaSiglaPEC() {
		...
		String retornado = buscaController.transformaSigla("Projeto de Emenda à Constituição");
		assertEquals(siglaEsperada, retornado);
	}
	...
	public void testTransformaSiglaPLP() {
		...
		String retornado = buscaController.transformaSigla("Projeto de Lei Complementar");
		assertEquals(siglaEsperada, retornado);
	}
	...
	public void testTransformaSiglaPRC() {
		...
		String retornado = buscaController.transformaSigla("Projeto de Resolução");
		assertEquals(siglaEsperada, retornado);
	}
